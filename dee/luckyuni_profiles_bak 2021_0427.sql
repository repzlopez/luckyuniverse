...
--
-- Host: localhost:3306
-- Generation Time: Apr 27, 2021 at 03:55 AM
...
--
-- Table structure for table `test_distri`
--

CREATE TABLE `test_distri` (
  `dsdid` int(8) UNSIGNED ZEROFILL NOT NULL,
  `dslnam` varchar(255) DEFAULT NULL,
  `dsfnam` varchar(255) NOT NULL,
  `dsmnam` varchar(255) DEFAULT NULL,
...
--
-- Indexes for table `test_distri`
--
ALTER TABLE `test_distri`
  ADD PRIMARY KEY (`dsdid`);
...
--
ALTER TABLE `distributors`
  MODIFY `dsdid` int(8) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=485;

--
-- AUTO_INCREMENT for table `test_distri`
--
ALTER TABLE `test_distri`
  MODIFY `dsdid` int(8) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=486;
COMMIT;
