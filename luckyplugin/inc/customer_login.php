...
<form method="post" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" class="form-data" id="login"><ul>
     <li><h3>Login</h3><input type="hidden" name="action" value="customers_login" /></li>
     <li><input type="text" name="contact" class="w5" placeholder="Contact #" minlength=4 required /></li>
     <li><input type="text" name="customer_name" class="w5" placeholder="Name" minlength=4 required /></li>
